...
c.find("."+e+"_content").removeClass(e+"_contentOverflow"):c.find("."+e+"_content").addClass(e+"_contentOverflow");k()})):("object"==a.type(l.html)&&(l.html=l.html.html()),f.append(l.html));d.after(b);c=a("."+e);c.find("."+e+"_footer")&&c.find("."+e+"_content").css({marginBottom:c.find("."+e+"_footer").outerHeight()+"px"});a.isFunction(l.html)||(-1!=("string"==a.type(l.html)?l.html:l.html[0].outerHTML).search(/<form/)||200>c.find("."+e+"_content").outerHeight())&&c.find("."+e+"_content").removeClass(e+
"_contentOverflow");if(l.onLoad&&a.isFunction(l.onLoad))l.onLoad();c.on("destroyed",function(){if(l.onClose&&a.isFunction(l.onClose))l.onClose()});p=!0;("absolute"!=d.parent().css("position")||"fixed"!=d.parent().css("position"))&&270>c.find("."+e+"_content").width()&&60>c.find("."+e+"_content").height()&&(p=!1);k();if(l.onDocumentClickClose)a("html").on("click."+e+"Event",function(b){a(this).addClass(e+"Open");c.is(":hidden")&&h();var g=a(b.target);g.parents().andSelf().is("."+e)||g.parents().andSelf().is(d)||
(b=parseInt(g.parents().filter(function(){return"auto"!==a(this).css("zIndex")}).first().css("zIndex")),isNaN(b)&&(b=0),g=g.css("zIndex"),"auto"==g&&(g=0),b<g&&(b=g),b<=c.css("zIndex")&&h())});a(window).resize(function(){k()});c.find(".close").bind("click",function(){h()});c.find('[data-popModalBut="close"]').bind("click",function(){h()});c.find('[data-popModalBut="ok"]').bind("click",function(c){var e;l.onOkBut&&a.isFunction(l.onOkBut)&&(e=l.onOkBut(c));!1!==e&&h()});c.find('[data-popModalBut="cancel"]').bind("click",
function(){if(l.onCancelBut&&a.isFunction(l.onCancelBut))l.onCancelBut();h()});a("html").on("keydown."+e+"Event",function(a){27==a.keyCode&&h()})}},hide:function(){h()}};if(y[b])return y[b].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof b||!b)return y.init.apply(this,arguments)};a("* [data-popModalBind]").bind("click",function(){var b=a(this).attr("data-popModalBind"),b={html:a(b).html()};void 0!=a(this).attr("data-placement")&&(b.placement=a(this).attr("data-placement"));
void 0!=a(this).attr("data-showCloseBut")&&(b.showCloseBut=/^true$/i.test(a(this).attr("data-showCloseBut")));void 0!=a(this).attr("data-overflowContent")&&(b.overflowContent=/^true$/i.test(a(this).attr("data-overflowContent")));void 0!=a(this).attr("data-onDocumentClickClose")&&(b.onDocumentClickClose=/^true$/i.test(a(this).attr("data-onDocumentClickClose")));a(this).popModal(b)});a.event.special.destroyed={remove:function(a){a.handler&&a.handler()}}})(jQuery);
