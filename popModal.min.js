...
function(b){var c;h.onOkBut&&a.isFunction(h.onOkBut)&&(c=h.onOkBut(b));!1!==c&&k();a(this).off("click")});b.find('[data-popmodal-but="cancel"]').on("click",function(){if(h.onCancelBut&&a.isFunction(h.onCancelBut))h.onCancelBut();k();a(this).off("click")});a("html").on("keydown.popModalEvent",function(a){27==a.keyCode&&k()})}return b},hide:function(){k()}};if(p[c])return p[c].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof c||!c)return p.init.apply(this,arguments)};a("* [data-popmodal-bind]").bind("click",
