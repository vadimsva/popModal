...
(c=parseInt(e.parents().filter(function(){return"auto"!==a(this).css("zIndex")}).first().css("zIndex")),isNaN(c)&&(c=0),""!=h.onDocumentClickClosePrevent&&e.is(h.onDocumentClickClosePrevent)&&(c=9999),e=e.css("zIndex"),"auto"==e&&(e=0),c<e&&(c=e),c<=b.css("zIndex")&&k())});a(window).resize(function(){g()});b.find(".close").bind("click",function(){k()});b.find('[data-popmodal-but="close"]').bind("click",function(){k()});b.find('[data-popmodal-but="ok"]').bind("click",function(b){var c;h.onOkBut&&a.isFunction(h.onOkBut)&&
(c=h.onOkBut(b));!1!==c&&k()});b.find('[data-popmodal-but="cancel"]').bind("click",function(){if(h.onCancelBut&&a.isFunction(h.onCancelBut))h.onCancelBut();k()});a("html").on("keydown.popModalEvent",function(a){27==a.keyCode&&k()})}},hide:function(){k()}};if(p[c])return p[c].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof c||!c)return p.init.apply(this,arguments)};a("* [data-popmodal-bind]").bind("click",function(){var c=a(this).attr("data-popmodal-bind"),c={html:a(c)};void 0!=
a(this).attr("data-placement")&&(c.placement=a(this).attr("data-placement"));void 0!=a(this).attr("data-showclose-but")&&(c.showCloseBut=/^true$/i.test(a(this).attr("data-showclose-but")));void 0!=a(this).attr("data-overflowcontent")&&(c.overflowContent=/^false$/i.test(a(this).attr("data-overflowcontent")));void 0!=a(this).attr("data-ondocumentclick-close")&&(c.onDocumentClickClose=/^true$/i.test(a(this).attr("data-ondocumentclick-close")));void 0!=a(this).attr("data-ondocumentclick-close-prevent")&&
(c.onDocumentClickClosePrevent=a(this).attr("data-ondocumentclick-close-prevent"));void 0!=a(this).attr("data-inline")&&(c.inline=/^true$/i.test(a(this).attr("data-inline")));void 0!=a(this).attr("data-beforeloading-content")&&(c.beforeLoadingContent=a(this).attr("data-beforeloading-content"));a(this).popModal(c)});a.event.special.destroyed={remove:function(a){a.handler&&a.handler()}}})(jQuery);
...
b)/2-100+"px"}):d.css({marginTop:"60px"});setTimeout(function(){e.addClass("open")},f);h()}function h(){e.find('[data-dialogmodal-but="close"]').bind("click",function(){g()});e.find('[data-dialogmodal-but="ok"]').bind("click",function(c){var d;b.onOkBut&&a.isFunction(b.onOkBut)&&(d=b.onOkBut(c));!1!==d&&g()});e.find('[data-dialogmodal-but="cancel"]').bind("click",function(){if(b.onCancelBut&&a.isFunction(b.onCancelBut))b.onCancelBut();g()})}b=a.extend({onOkBut:function(){return!0},onCancelBut:function(){},
onLoad:function(){},onClose:function(){}},c);a("html.dialogModalOpen").off(".dialogModalEvent").removeClass("dialogModalOpen");a(".dialogModal .dialogPrev, .dialogModal .dialogNext").off("click");a(".dialogModal").remove();var l=0,n=k.length-1;dialogMain=a('<div class="dialogModal"></div>');dialogContainer=a('<div class="dialogModal_container"></div>');dialogCloseBut=a('<button type="button" class="close">&times;</button>');dialogBody=a('<div class="dialogModal_body"></div>');dialogMain.append(dialogContainer);
dialogContainer.append(dialogCloseBut,dialogBody);dialogBody.append(k[l].innerHTML);0<n&&dialogContainer.prepend(a('<div class="dialogPrev notactive"></div><div class="dialogNext"></div>'));a("body").append(dialogMain);e=a(".dialogModal");d=a(".dialogModal_container");f||(f=e.css("transitionDuration"),f=void 0!=f?1E3*f.replace("s",""):0);if(b.onLoad&&a.isFunction(b.onLoad))b.onLoad();e.on("destroyed",function(){if(b.onClose&&a.isFunction(b.onClose))b.onClose()});c=window.innerWidth-a(window).outerWidth();
a("body").css({paddingRight:c+"px"}).addClass("dialogModalOpen");m();e.find(".dialogPrev").bind("click",function(){0<l&&(--l,l<n&&e.find(".dialogNext").removeClass("notactive"),0==l&&e.find(".dialogPrev").addClass("notactive"),dialogBody.empty().append(k[l].innerHTML),m())});e.find(".dialogNext").bind("click",function(){l<n&&(++l,0<l&&e.find(".dialogPrev").removeClass("notactive"),l==n&&e.find(".dialogNext").addClass("notactive"),dialogBody.empty().append(k[l].innerHTML),m())});e.find(".close").bind("click",
function(){g()});a("html").on("keydown.dialogModalEvent",function(a){27==a.keyCode?g():37==a.keyCode?e.find(".dialogPrev").click():39==a.keyCode&&e.find(".dialogNext").click()})},hide:function(){g()}};if(n[c])return n[c].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof c||!c)return n.init.apply(this,arguments)};a("* [data-dialogmodal-bind]").bind("click",function(){var c=a(this).attr("data-dialogmodal-bind");a(c).dialogModal()});a.event.special.destroyed={remove:function(a){a.handler&&
a.handler()}}})(jQuery);
